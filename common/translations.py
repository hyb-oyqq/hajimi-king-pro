...
class Translations:
    ...
    TRANSLATIONS = {
        'zh_cn': {
            ...
            'query_syntax_error': '❌ 查询语法错误 (HTTP 422) - 查询: {}... | 错误: {} | 已跳过此查询',
            'query_syntax_error_skip': '⚠️ 查询 {}/{} 因语法错误被跳过 (不触发冷却): {}',
            'token_invalid': '❌ GitHub Token 无效 (HTTP 401) - Token: {}... | 错误: {}',
            'token_forbidden': '❌ GitHub Token 权限不足或被禁止 (HTTP 403) - Token: {}... | 错误: {}',
            'token_rate_limited': '⚠️ GitHub Token 达到速率限制 (HTTP 429) - Token: {}... | 剩余: {} | 重置时间: {}',
            'token_error_detail': '❌ GitHub API 错误 (HTTP {}) - Token: {}... | 错误消息: {}',
            ...
            # 数据库相关
            'db_connected': '✅ 已连接到 {} 数据库: {}',
            'db_connect_failed': '❌ 连接 {} 数据库失败: {}',
            'db_tables_initialized': '✅ {} 表初始化成功',
            'db_tables_init_failed': '❌ {} 表初始化失败: {}',
            'db_keys_saved': '✅ 已保存 {} 个 {} 类型的密钥到 {}',
            'db_keys_save_failed': '❌ 保存密钥到 {} 失败: {}',
            'db_keys_get_failed': '❌ 从 {} 获取密钥失败: {}',
            'db_manager_init_failed': '❌ 数据库管理器初始化失败: {}',
            'db_manager_initialized': '✅ 数据库管理器已初始化: {}',
            'db_manager_create_failed': '⚠️ 创建数据库管理器失败，类型: {}',
            'db_type_unsupported': '❌ 不支持的数据库类型: {}',
            'db_driver_missing': '❌ {} 未安装，请安装: pip install {}',
            
            # 数据迁移相关
            'migration_starting': '🔄 开始从文本文件迁移数据到数据库',
            'migration_keys_dir_not_found': '📁 未找到 keys 文件夹，无需迁移',
            'migration_no_files': '📁 keys 文件夹中未找到密钥文件，无需迁移',
            'migration_files_found': '📁 发现 {} 个密钥文件，需要迁移',
            'migration_found_files': '📂 发现 {} 个密钥文件',
            'migration_found_detail_files': '📂 发现 {} 个详细日志文件',
            'migration_completed': '✅ 迁移完成: {} 个密钥已迁移',
            'migration_failed': '❌ 迁移失败: {}',
            'migration_file_processing': '📄 正在迁移 {} 密钥，文件: {}',
            'migration_file_migrated': '  ✅ 已迁移 {} 个 {} 密钥',
            'migration_file_failed': '  ⚠️ {} 密钥迁移失败',
            'migration_file_no_keys': '  ℹ️ 文件中未找到有效密钥',
            'migration_file_error': '  ❌ 迁移文件 {} 时出错: {}',
            'migration_detail_processing': '📄 正在从详细日志迁移 {} 密钥: {}',
            'migration_detail_migrated': '  ✅ 已迁移 {} 个带元数据的 {} 密钥',
            'migration_detail_no_keys': '  ℹ️ 详细日志中未找到有效密钥',
            'migration_detail_error': '  ❌ 迁移详细日志 {} 时出错: {}',
            'migration_backup_keys': '📦 已备份 keys 文件夹到: {}',
            'migration_backup_logs': '📦 已备份日志文件到: {}',
            'migration_backup_completed': '✅ 备份完成: {}',
            'migration_backup_failed': '❌ 备份文件失败: {}',
            'migration_cleanup_keys': '🗑️ 已删除 keys 文件夹: {}',
            'migration_cleanup_log': '🗑️ 已删除日志文件: {}',
            'migration_cleanup_completed': '✅ 清理完成',
            'migration_cleanup_failed': '❌ 清理文件失败: {}',
            'migration_keys_already_removed': 'ℹ️ keys 文件夹已被删除',
            'migration_check_detected': '🔄 数据迁移检测：发现历史密钥文件，开始迁移...',
            'migration_check_completed': '✅ 数据迁移完成，程序将继续运行',
            'migration_check_failed': '❌ 数据迁移失败，请检查错误信息',
            'migration_check_hint': '提示：您可以暂时设置 STORAGE_TYPE=text 来使用文本文件存储',
            'migration_check_not_needed': '✅ 无需数据迁移',
        },
        'en': {
            # System startup
            ...
            'query_syntax_error': '❌ Query Syntax Error (HTTP 422) - Query: {}... | Error: {} | Query skipped',
            'query_syntax_error_skip': '⚠️ Query {}/{} skipped due to syntax error (no cooldown triggered): {}',
            'token_invalid': '❌ GitHub Token Invalid (HTTP 401) - Token: {}... | Error: {}',
            'token_forbidden': '❌ GitHub Token Forbidden or Insufficient Permissions (HTTP 403) - Token: {}... | Error: {}',
            'token_rate_limited': '⚠️ GitHub Token Rate Limited (HTTP 429) - Token: {}... | Remaining: {} | Reset Time: {}',
            'token_error_detail': '❌ GitHub API Error (HTTP {}) - Token: {}... | Error Message: {}',
            ...
            'db_tables_initialized': '✅ {} tables initialized successfully',
            'db_tables_init_failed': '❌ Failed to initialize {} tables: {}',
            'db_keys_saved': '✅ Saved {} keys of type \'{}\' to {}',
            'db_keys_save_failed': '❌ Failed to save keys to {}: {}',
            'db_keys_get_failed': '❌ Failed to get keys from {}: {}',
            'db_manager_init_failed': '❌ Failed to initialize database manager: {}',
            'db_manager_initialized': '✅ Database manager initialized: {}',
            'db_manager_create_failed': '⚠️ Failed to create database manager for type: {}',
            'db_type_unsupported': '❌ Unsupported database type: {}',
            'db_driver_missing': '❌ {} not installed. Please install it: pip install {}',
            
            # Migration related
            'migration_starting': '🔄 Starting data migration from text files to database',
            'migration_keys_dir_not_found': '📁 Keys directory not found, no migration needed',
            'migration_no_files': '📁 No key files found in keys directory, no migration needed',
            'migration_files_found': '📁 Found {} key files, migration needed',
            'migration_found_files': '📂 Found {} key files',
            'migration_found_detail_files': '📂 Found {} detail log files',
            'migration_completed': '✅ Migration completed: {} keys migrated',
            'migration_failed': '❌ Migration failed: {}',
            'migration_file_processing': '📄 Migrating {} keys from: {}',
            'migration_file_migrated': '  ✅ Migrated {} {} keys',
            'migration_file_failed': '  ⚠️ Failed to migrate {} keys',
            'migration_file_no_keys': '  ℹ️ No valid keys found in file',
            'migration_file_error': '  ❌ Error migrating file {}: {}',
            'migration_detail_processing': '📄 Migrating {} keys from detail log: {}',
            'migration_detail_migrated': '  ✅ Migrated {} {} keys with metadata',
            'migration_detail_no_keys': '  ℹ️ No valid keys found in detail log',
            'migration_detail_error': '  ❌ Error migrating detail file {}: {}',
            'migration_backup_keys': '📦 Backed up keys folder to: {}',
            'migration_backup_logs': '📦 Backed up log files to: {}',
            'migration_backup_completed': '✅ Backup completed: {}',
            'migration_backup_failed': '❌ Failed to backup files: {}',
            'migration_cleanup_keys': '🗑️ Removed keys folder: {}',
            'migration_cleanup_log': '🗑️ Removed log file: {}',
            'migration_cleanup_completed': '✅ Cleanup completed',
            'migration_cleanup_failed': '❌ Failed to cleanup files: {}',
            'migration_keys_already_removed': 'ℹ️ Keys folder already removed',
            'migration_check_detected': '🔄 Migration check: Found historical key files, starting migration...',
            'migration_check_completed': '✅ Data migration completed, program will continue',
            'migration_check_failed': '❌ Data migration failed, please check error messages',
            'migration_check_hint': 'Hint: You can temporarily set STORAGE_TYPE=text to use text file storage',
            'migration_check_not_needed': '✅ No migration needed',
        }
    }
