...
class Translations:
    ...
    TRANSLATIONS = {
        'zh_cn': {
            ...
            'gpt_load_enabled': '✅ GPT Load Balancer 已启用, URL: {}',
            'gpt_load_missing': '⚠️ GPT Load Balancer Auth, URL 或 Group Name 缺失 (Load Balancer功能将被禁用)',
            'gpt_load_ok': '✅ GPT Load Balancer Auth: ****',
            'gpt_load_group_name': '✅ GPT Load Balancer Group Name: {}',
            'gpt_load_not_configured': 'ℹ️ GPT Load Balancer: 未配置 (Load Balancer功能将被禁用)',
            ...
            'gpt_load_sync_disabled': '🚫 GPT Load Balancer 同步已禁用 - URL、AUTH、GROUP_NAME 未配置或同步已禁用',
            'gpt_load_enabled_url': '🔗 GPT Load Balancer 已启用 - URL: {}, 组: {}',
            ...
            'added_to_gpt_load_queue': '📥 已添加 {} 个密钥到 GPT load balancer 队列 (总数: {})',
            'gpt_load_disabled_skipping': '🚫 GPT Load Balancer 已禁用，跳过 {} 个密钥',
            ...
            'sending_to_gpt_load': '🔄 正在为 {} 个组发送 {} 个密钥到 GPT load balancer...',
            ...
            'request_timeout_gpt_load': '❌ 连接到 GPT load balancer 时请求超时',
            'connection_failed_gpt_load': '❌ 连接到 GPT load balancer 失败',
            'invalid_json_gpt_load': '❌ GPT load balancer 返回的 JSON 无效: {}',
            'failed_send_to_gpt_load': '❌ 发送密钥到 GPT load balancer 失败: {}',
            ...
            'processing_gpt_load_queue': '🔄 正在处理 GPT load balancer 队列中的 {} 个密钥',
            'gpt_load_queue_cleared': '✅ GPT load balancer 队列处理成功，已清除 {} 个密钥',
            'gpt_load_queue_failed': '❌ GPT load balancer 队列处理失败，代码: {}',
        ...
        'en': {
            ...
            'gpt_load_enabled': '✅ GPT Load Balancer enabled, URL: {}',
            'gpt_load_missing': '⚠️ GPT Load Balancer Auth, URL or Group Name Missing (Load Balancer disabled)',
            'gpt_load_ok': '✅ GPT Load Balancer Auth: ****',
            'gpt_load_group_name': '✅ GPT Load Balancer Group Name: {}',
            'gpt_load_not_configured': 'ℹ️ GPT Load Balancer: Not configured (Load Balancer disabled)',
            ...
            'gpt_load_sync_disabled': '🚫 GPT Load Balancer sync disabled - URL, AUTH, GROUP_NAME not configured or sync disabled',
            'gpt_load_enabled_url': '🔗 GPT Load Balancer enabled - URL: {}, Groups: {}',
            ...
            'added_to_gpt_load_queue': '📥 Added {} key(s) to GPT load balancer queue (total: {})',
            'gpt_load_disabled_skipping': '🚫 GPT Load Balancer disabled, skipping {} key(s) for GPT load balancer queue',
            ...
            'sending_to_gpt_load': '🔄 Sending {} key(s) to GPT load balancer for {} group(s)...',
            ...
            'request_timeout_gpt_load': '❌ Request timeout when connecting to GPT load balancer',
            'connection_failed_gpt_load': '❌ Connection failed to GPT load balancer',
            'invalid_json_gpt_load': '❌ Invalid JSON response from GPT load balancer: {}',
            'failed_send_to_gpt_load': '❌ Failed to send keys to GPT load balancer: {}',
            ...
            'processing_gpt_load_queue': '🔄 Processing {} key(s) from GPT load balancer queue',
            'gpt_load_queue_cleared': '✅ GPT load balancer queue processed successfully, cleared {} key(s)',
            'gpt_load_queue_failed': '❌ GPT load balancer queue processing failed with code: {}',
